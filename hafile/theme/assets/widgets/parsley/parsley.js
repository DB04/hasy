...
// Define then the messages
    window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
        ...
        type: {
            ...
            number:       "Vui lòng điền số hợp lệ.",
            integer:      "This value should be a valid integer.",
            digits:       "This value should be digits.",
            alphanum:     "Vui lòng nhập kí tự alphanum."
        },
        notblank:       "This value should not be blank.",
        required:       "Vui lòng nhập đầy đủ thông tin.",
        pattern:        "This value seems to be invalid.",
        min:            "Vui lòng nhập ít nhất %s.",
        max:            "Vui lòng nhập nhiều nhất %s.",
        range:          "Vui lòng nhập giá trị trong khoảng %s và %s.",
        minlength:      "Vui lòng nhập ít nhất %s kí tự.",
        maxlength:      "Vui lòng nhập nhiều nhất %s kí tự.",
