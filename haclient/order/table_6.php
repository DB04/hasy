        ...
        <div class="example-box-wrapper">
            <div class="scroll-columns">
                <table class="table table-bordered table-striped table-condensed cf">
                    ...
                    <tbody>
<?PHP 
$page = addslashes($_GET['page_may']) * 20;
  if($page > 0){
      $page = $page;
  }
$data = $mysql->pagging('donhang','`3` = 1 AND `5` = 1 AND `6` = 0', $page.', 20');
$num_rows = $data['row'];
...
?>
                    <tr class="tr-<?php echo $data[$i]['id']; ?>">
                        ...
                        <td><a href="#edit" data-id="<?php echo $data[$i]['id']; ?>-6" data-toggle="modal" data-target="#edit-modal-data" class="opacity-dialog-80" id="data-modal-edit"><i class="glyph-icon icon-legal"></i></a></td>
                        <td><a href="#thongtin" data-id="<?php echo $data[$i]['id']; ?>-6" data-toggle="modal" data-target="#view-modal" class="opacity-dialog-60" id="data-modal-ok"><i class="glyph-icon icon-eye"></i></a></td>
                    </tr>
                        <?php } ?>
...
<?php 
$order = $mysql->where('3', 1)->where('5', 1)->where('6', 0)->get('donhang');
$all = $mysql->num_rows(); 
...
<div class="col-sm-6">
    <div class="dataTables_paginate paging_bootstrap" id="datatable-example_paginate">
        <ul class="pagination">
            ...
            <li class="">
                <a href="<?php echo link;?>&page_may=<?php echo $i; ?>"><?php echo $i+1; ?></a>
            </li>
<?php } ?>
        </ul>
    </div></div>
