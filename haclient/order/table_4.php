...
$data = $mysql->pagging('donhang','`1` = 1 AND `4` = 0', $page.', 20');
$num_rows = $data['row'];
...
?>
                    <tr class="tr-<?php echo $data[$i]['id']; ?>">
                        ...
                        <td><a href="#edit" data-id="<?php echo $data[$i]['id']; ?>-4" data-toggle="modal" data-target="#edit-modal-data" class="opacity-dialog-80" id="data-modal-edit"><i class="glyph-icon icon-legal"></i></a></td>
                        <td><a href="#thongtin" data-id="<?php echo $data[$i]['id']; ?>-4" data-toggle="modal" data-target="#view-modal" class="opacity-dialog-60" id="data-modal-ok"><i class="glyph-icon icon-eye"></i></a></td>
                    </tr>
                        <?php } ?>
...
<?php 
$order = $mysql->where('1', 1)->where('4', 0)->get('donhang');
$all = $mysql->num_rows(); 
...
<div class="col-sm-6">
    <div class="dataTables_paginate paging_bootstrap" id="datatable-example_paginate">
        <ul class="pagination">
            ...
            <li class="">
                <a href="<?php echo link;?>&page_vai=<?php echo $i; ?>"><?php echo $i+1; ?></a>
            </li>
<?php } ?>
        </ul>
    </div></div>
