...
$data = $mysql->where('status', 8)->order_by('id','ASC')->limit($page.', 5')->get('donhang');
...
?>
                            ...
                            <tr>
                              ...
                              <td class="text-right">
                                ...
                                <button class="btn btn-danger" type="submit"> BỊ HOÀN</button>
                              </a>
                              </td>
                     ...
                     <div class="controls-below-table">
                        <div class="table-records-info">
                          Tổng
                          <?php 
$order = $mysql->where('status', 8)->get('donhang');
$all = $mysql->num_rows(); 
$trang = floor($all/5+1);
echo $all.' đơn';
?>                        </div>
