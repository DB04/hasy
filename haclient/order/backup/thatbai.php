                    ...
                    <div class="element-box">
                      <div class="table-responsive">
                        <table class="table table-lightborder">
                          ...
                          <tbody>
                          	<?PHP 
$page = addslashes($_GET['page_cancel']) * 5;
  if($page > 0){
      $page = $page - 1;
  }
$data = $mysql->where('status', 7)->order_by('id','ASC')->limit($page.', 5')->get('donhang');
...
?>
                     ...
                     <div class="controls-below-table">
                        <div class="table-records-info">
                         Tổng: 
<?php 
$order = $mysql->where('status', 7)->get('donhang');
$all = $mysql->num_rows(); 
$trang = floor($all/5+1);
echo $all.' đơn';
?>                        </div>
...
<?php for($i=1;$i<$trang+1;$i++){ ?>
                            ...
                            <li>
                              <a href="<?php echo link;?>&page_cancel=<?php echo $i-1; ?>"><?php echo $i ?></a>
                            </li>
<?php } ?>
